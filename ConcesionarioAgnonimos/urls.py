"""ConcesionarioAgnonimos URL Configuration
...
urlpatterns = [
  ...
  + static("/imagenes/General/", document_root=settings.BASE_DIR+"/imagenes/General/") \
  + static("/static/", document_root=settings.BASE_DIR+"/catalogo/static/css/")
