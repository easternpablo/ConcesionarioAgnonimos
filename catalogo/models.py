...
=======
    taller_id = models.ForeignKey('Taller', on_delete=models.CASCADE)       #nuevo
...
class Coche(models.Model):
   ...
   # taller_id = models.ForeignKey('Taller', on_delete=models.CASCADE)             #he añadido id de taller
...
class Venta(models.Model):
    ...
    def __str__(self):
>>>>>>> 53f6174a412580c8da78c3709f51ce879c23a215
        return f"{self.coche_id} -> {self.cliente_id} -> {self.empleado_id} -> {self.fecha}" 
